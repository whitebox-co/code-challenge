...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url('https://picsum.photos/1920/239/?random');">
						...
						<div class="filter-price p-t-22 p-b-50 bo3">
							...
							<div class="flex-sb-m flex-w p-t-16">
								...
								<div class="s-text3 p-t-10 p-b-10">
									Range: $<span id="value-lower">100</span> - $<span id="value-upper">120</span>
								</div>
							</div>
						</div>
...
<script src='./public/js/product.filter.js'> </script>
</html>
`;
