				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="/GetMany">Shop</a>
							</li>

							<li class="sale-noti">
								<a href="/GetMany">Sale</a>
							</li>
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="item-slick3 main" data-thumb={{selectedItem.image}}>
						<div class="wrap-pic-w">
							<img src={{selectedItem.image}} alt="IMG-PRODUCT">
						</div>
					</div>

					<div class="slick3">
						<div class="item-slick3" data-thumb={{selectedItem.image}}>
							<div class="wrap-pic-w">
								<img src={{selectedItem.image}} alt="IMG-PRODUCT">
							</div>
						</div>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="p-b-45">
					<span class="s-text8 m-r-35">SKU: {{selectedItem.guid}}</span>
					<span class="s-text8">Categories: {{selectedItem.tags}}</span>
				</div>
          ...
          <div class="item-slick2 p-l-15 p-r-15">
            ...
            <div class="block2">
              ...
              <div class="block2-txt p-t-20">
                <a href="/GetSingle/{{guid}}" class="block2-name dis-block s-text3 p-b-5">
                  {{name}}
                </a>
...
module.exports = productDetailHTML;
